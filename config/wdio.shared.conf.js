...
//const commands = path.join(process.cwd(), './commands.js'); //commands.js
...
exports.config = {
  ...
  //
  // specs: [
  //     './test/spec/login*.feature' //'./features/*.feature'
  // ],
  // Patterns to exclude.
  exclude: [
  ...
  cucumberOpts: {
    // <string[]> (file/dir) require files before executing features test\spec\login-spec\login-spec.js
    require: [
      "./test/spec/**/login*.js",
      //'./test/spec/**/view-company-mood-spec.js'
    ], //['./stepDefinition/*.js'],
